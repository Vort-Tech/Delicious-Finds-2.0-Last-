...
<body>
  ...
  <main class="main" id="top">
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
      <div class="container"><a class="navbar-brand d-inline-flex" href="index_login.php"><img class="d-inline-block" src="assets/img/gallery/logo.svg" alt="logo" /><span class="text-1000 fs-3 fw-bold ms-2 text-gradient">Dilicious Finds</span></a>
    ...
    <section class="py-0">
      ...
      <div class="container">
        <div class="row h-100 gx-2 mt-7" id="offer"></div>
      </div>
    ...
    <!-- ============================================-->
    <!-- <section> begin ============================-->
    <section class="py-4 overflow-hidden" id="popularitem">
            ...
            <div class="carousel slide" id="carouselPopularItems" data-bs-touch="false" data-bs-interval="false">
              <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row gx-3 h-100 align-items-center justify-content-center" id="cardData"></div>
                  </div>

                  <div class="carousel-item" data-bs-interval="5000">
                    <div class="row gx-3 h-100 align-items-center justify-content-center" id="cardData2"></div>
                  </div>
      ...
      <div class="container">
        <div class="row h-100">
          <div class="col-lg-7 mx-auto text-center mb-6">
            <h5 class="fw-bold fs-3 fs-lg-5 lh-sm mb-3" id="restaurants">Featured Restaurants</h5>
          </div>
        </div>

        <div class="row gx-2" id="restaurant"></div>

        <div class="col-12 mt-5 text-center"> <a class="btn btn-lg btn-primary" href="Feature_restaurants.php">View All <i class="fas fa-chevron-right ms-2"> </i></a>
        </div>
      </div>
            ...
            <div class="carousel slide" id="carouselSearchByFood" data-bs-touch="false" data-bs-interval="false">
              <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                  ...
                  <div class="row h-100 align-items-center" id="searchslide1"></div>
                
                </div>
                
                <div class="carousel-item" data-bs-interval="5000">
                
                  <div class="row h-100 align-items-center" id="searchslide2"></div>
    ...
    <!-- ============================================-->
    <!-- <section> begin ============================-->
    <section class="pb-5 pt-8" id="banner1">

    </section>

    <section class="py-0" id="banner2">

    </section>

    <section class="pt-5" id="banner3">
      ...
      <div class="container">
        <div class="row justify-content-lg-between">
          ...
          <div class="col-6 col-md-4 col-lg-auto mb-3">
            <ul class="list-unstyled mb-md-4 mb-lg-0">
              ...
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Thatta</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Badin</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Clifton</a></li>
            </ul>
          </div>
          <div class="col-6 col-md-4 col-lg-auto mb-3">
            <ul class="list-unstyled mb-md-4 mb-lg-0">
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Shah Faisal</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Korangi</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Landhi</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Gulshan</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Gulistan-e-Johr</a></li>
            </ul>
          </div>
          <div class="col-6 col-md-4 col-lg-auto mb-3">
            <ul class="list-unstyled mb-md-4 mb-lg-0">
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">New Karachi</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Liyari</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Nazimabad</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Lalu Khait</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Hawksby</a></li>
            </ul>
          </div>
          <div class="col-6 col-md-4 col-lg-auto mb-3">
            <ul class="list-unstyled mb-md-4 mb-lg-0">
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Malir</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Khokharapar</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Quaidabad</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Gulshan-e-Hadeed</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Steel Town</a></li>
            </ul>
          </div>
          <div class="col-6 col-md-4 col-lg-auto mb-3">
            <ul class="list-unstyled mb-md-4 mb-lg-0">
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Drigh Road</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Saddar</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Light House</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Jinnah Square</a></li>
              <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!">Malir Cantt</a></li>
            </ul>
          </div>
        </div>
        <hr class="text-900" />
        <div class="row">
          ...
          <div class="col-12 col-md-8 col-lg-6 col-xxl-4">
            ...
            <div class=" row input-group-icon mb-5">
              <div class="col-auto subscribe"><i class="fas fa-envelope input-box-icon text-500 ms-3"></i>
                <input class=" form-control input-box bg-800 border-0" type="email" placeholder="Enter Email" aria-label="email" />
              </div>
              <div class="col-auto">
                <button class="btn btn-primary p-3" type="submit">Subscribe</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row flex-center pb-3">
          <div class="col-md-6 order-0">
            <p class="text-200 text-center text-md-start">All rights Reserved &copy; Delicious Finds, 2022</p>
          </div>
          <div class="col-md-6 order-1">
            <p class="text-200 text-center text-md-end"> Made with&nbsp;
              ...
              </svg>&nbsp;by&nbsp;<a class="text-200 fw-bold" href="#" target="_blank">Team_Alpha </a>
            </p>
          </div>
        </div>
      </div><!-- end of .container-->
...
<script src="popularitem.js"></script>
...
<script>
            for (i = 0; i < offer.length; i++) {
              ...
              <img class='img-fluid rounded-3 w-100' src='${offer[i].offerimage}'>
              <div class='card-actions'>
              <div class='badge badge-foodwagon bg-primary p-4'>
              <div class='d-flex flex-between-center'>
              <div class='text-white fs-7'>${offer[i].offerpercentage}</div>
              ...
              <h5 class='fw-bold text-1000 text-truncate'>${offer[i].offerfoodname}</h5>
              <span class='badge bg-soft-danger py-2 px-3'>
              <span class='fs-1 text-danger'>${offer[i].dayremaining}</span>
              </span>
  ...
  for (i = 0; i < popularitem1.length; i++) {
                    document.querySelector("#cardData").innerHTML += `
                      <div class='col-sm-6 col-md-4 col-xl mb-5 h-100'>
                      <form action="manage_cart.php" method="POST">
                      <div class='card card-span h-100 rounded-3'>
                      <img class='img-fluid rounded-3 h-100' src='${popularitem1[i].image}'>
                      <div class='card-body ps-0'>
                      <h5 class='fw-bold text-1000 text-truncate mb-1'>${popularitem1[i].foodname}</h5>
                      <div>
                      <span class='text-warning me-2'><i class='fas fa-map-marker-alt'></i></span>
                      <span class='text-primary'>${popularitem1[i].location}</span></div>
                      <div class="d-flex justify-content-between" ><span class='text-1000 fw-bold'>PKR ${popularitem1[i].Price}</span><input type="number" name="Qty" value="1" min="1" max="10"></div>
                      </div>
                      </div>
                      <div class='d-grid gap-2'>
                      <button type='submit' name='Add_To_Cart' class='btn btn-lg btn-danger'>Order now</button>
                      <input type="hidden" name="Item_Name" value="${popularitem1[i].foodname}">
                      <input type="hidden" name="Price" value="${popularitem1[i].Price}">
                      </div>
                      </form>
                      </div>
                      `
                  };
  for (i = 0; i < popularitem2.length; i++) {
                      document.querySelector("#cardData2").innerHTML += `
                      <div class='col-sm-6 col-md-4 col-xl mb-5 h-100'>
                      <form action="manage_cart.php" method="POST">
                      <div class='card card-span h-100 rounded-3'>
                      <img class='img-fluid rounded-3 h-100' src='${popularitem2[i].image}'>
                      <div class='card-body ps-0'>
                      <h5 class='fw-bold text-1000 text-truncate mb-1'>${popularitem2[i].foodname}</h5>
                      <div>
                      <span class='text-warning me-2'><i class='fas fa-map-marker-alt'></i></span>
                      <span class='text-primary'>${popularitem2[i].location}</span></div>
                      <div class="d-flex justify-content-between" ><span class='text-1000 fw-bold'>PKR ${popularitem2[i].Price}</span><input type="number" name="Qty" value="1" min="1" max="10"></div>
                      </div>
                      </div>
                      <div class='d-grid gap-2'>
                      <button type='submit' name='Add_To_Cart' class='btn btn-lg btn-danger'>Order now</button>
                      <input type="hidden" name="Item_Name" value="${popularitem2[i].foodname}">
                      <input type="hidden" name="Price" value="${popularitem2[i].Price}">
                      </div>
                      </form>
                      </div>`
  ...
  for (i = 0; i < searchslide1.length; i++) {
    document.querySelector("#searchslide1").innerHTML += `
                    <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                      <div class="card card-span h-100 rounded-circle">
                        <img class="img-fluid rounded-circle h-100" src="${searchslide1[i].image}" alt="..." />
                        <div class="card-body ps-0">
                          <h5 class="text-center fw-bold text-1000 text-truncate mb-2">${searchslide1[i].foodname}</h5>
                        </div>
                      </div>
                    </div>`
  };
  for (i = 0; i < searchslide2.length; i++) {
    document.querySelector("#searchslide2").innerHTML += `
                    <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                      <div class="card card-span h-100 rounded-circle">
                        <img class="img-fluid rounded-circle h-100" src="${searchslide2[i].image}" alt="..." />
                        <div class="card-body ps-0">
                          <h5 class="text-center fw-bold text-1000 text-truncate mb-2">${searchslide2[i].foodname}</h5>
                        </div>
                      </div>
                    </div>`
  };
  for (i = 0; i < banner1.length; i++) {
    document.querySelector("#banner1").innerHTML += `
    <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="card card-span mb-3 shadow-lg">
              <div class="card-body py-0">
                <div class="row justify-content-center">
                  <div class="col-md-5 col-xl-7 col-xxl-8 g-0 order-0 order-md-1"><img class="img-fluid w-100 fit-cover h-100 rounded-top rounded-md-end rounded-md-top-0" src="${banner1[i].image}" alt="..." /></div>
                  <div class="col-md-7 col-xl-5 col-xxl-4 p-4 p-lg-5">
                    <h1 class="card-title mt-xl-5 mb-4">Best deals <span class="text-primary"> ${banner1[i].name}</span></h1>
                    <p class="fs-1">${banner1[i].statement}</p>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-span mb-3 shadow-lg">
              <div class="card-body py-0">
                <div class="row justify-content-center">
                  <div class="col-md-5 col-xl-7 col-xxl-8 g-0 order-0 order-md-1"><img class="img-fluid w-100 fit-cover h-100 rounded-top rounded-md-end rounded-md-top-0" src="${banner2[i].image}" alt="..." /></div>
                  <div class="col-md-7 col-xl-5 col-xxl-4 p-4 p-lg-5">
                    <h1 class="card-title mt-xl-5 mb-4">Best deals <span class="text-primary"> ${banner2[i].name}</span></h1>
                    <p class="fs-1">${banner2[i].statement}</p>
                    <div class="d-grid bottom-0"><a class="btn btn-lg btn-primary mt-xl-6" href="#!">PROCEED TO ORDER<i class="fas fa-chevron-right ms-2"></i></a></div>
                  </div>
                </div>
              </div>
  ...
  for (i = 0; i < banner3.length; i++) {
    document.querySelector("#banner3").innerHTML += `
    <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="card card-span mb-3 shadow-lg">
              <div class="card-body py-0">
                <div class="row justify-content-center">
                  <div class="col-md-5 col-xl-7 col-xxl-8 g-0 order-0 order-md-1"><img class="img-fluid w-100 fit-cover h-100 rounded-top rounded-md-end rounded-md-top-0" src="${banner3[i].image}" alt="..." /></div>
                  <div class="col-md-7 col-xl-5 col-xxl-4 p-4 p-lg-5">
                    <h1 class="card-title mt-xl-5 mb-4">Best deals <span class="text-primary"> ${banner3[i].name}</span></h1>
                    <p class="fs-1">${banner3[i].statement}</p>
                    <div class="d-grid bottom-0"><a class="btn btn-lg btn-primary mt-xl-6" href="#!">PROCEED TO ORDER<i class="fas fa-chevron-right ms-2"></i></a></div>
                  </div>
                </div>
              </div>
