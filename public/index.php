  ...
  <body>
    ...
    <main class="main" id="top">
        ...
        <div class="container"><a class="navbar-brand d-inline-flex" href="index.php"><img class="d-inline-block" src="assets/img/gallery/logo.svg" alt="logo" /><span class="text-1000 fs-3 fw-bold ms-2 text-gradient">Dilicious Finds</span></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 my-2 mt-lg-0" id="navbarSupportedContent">
            ...
            <form class="d-flex mt-4 mt-lg-0 ms-lg-auto ms-xl-0" >
              ...
              <div><a href="login.php" class="btn bg-warning shadow-warning m-3" type="submit"> <i class="fas fa-user me-2"></i>Login</a></div>
            </form>
          </div>
        </div>
      </nav>
      ...
      <div class="container">
        ...
        <div class="col-12 mt-5 text-center"> <a class="btn btn-lg btn-primary" href="#!">View All <i class="fas fa-chevron-right ms-2"> </i></a>
        </div>
      </div>
...
<script>
            ...
            for (i = 0; i < popularitem1.length; i++) {
                    document.querySelector("#cardData").innerHTML += `
                      ...
                      <span class='text-primary'>${popularitem1[i].location}</span></div><span class='text-1000 fw-bold'>PKR ${popularitem1[i].Price}</span>
                      </div>
                      </div>
  ...
  for (i = 0; i < popularitem2.length; i++) {
                      ...
                      <div>
                      <span class='text-warning me-2'><i class='fas fa-map-marker-alt'></i></span>
                      <span class='text-primary'>${popularitem2[i].location}</span></div><span class='text-1000 fw-bold'>PKR ${popularitem2[i].Price}</span>
                      </div>
                      </div>
                      <div class='d-grid gap-2'>
                      <button type='submit' name='Add_To_Cart' class='btn btn-lg btn-danger'>Order now</button>
